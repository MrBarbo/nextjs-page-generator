...
const FullNameForm = ({
  ...
  return (
    <div className={styles.fullname_input} style={fullNameInputStyle}>
      <div className={styles.full_name}>{inputPlaceholder}</div>
      <div className={styles.nameinp} style={nameInpStyle}>
        <TextField
          className="text"
          color="primary"
          name={inputName}
